...
function editar(id) {
  ...
  url = "http://localhost:8083/api/Client";
...
function guardarNuevo() {
  ...
  url = "http://localhost:8083/api/Client/save";
...
function guardarEditar() {
  ...
  url = "http://localhost:8083/api/Client/update"
...
function guardarBorrar() {
  ...
  let url = "http://localhost:8083/api/Client";
